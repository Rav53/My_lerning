<?php 
$name = 'Равиль';
$prof = 'Ведущий инженер - техногог (ПОКА =-))))';
$city = 'Владимир';
$mail = 'qwert@mail.ru';
$telephone = '+7 (922) 235-25-46';
$skills = [
    [
        'name' => 'Фотошоп',
        'percent' => 30,
...
$work_experience = [
    [
        'work' => 'Опрессовщик кабелей и проводов',
        'dateStart' => 'Июнь 2006 -',
        'dateEnd' => 'Январь 2022',
        'description' => 'Изготавливал различные маркоразмеры силовых кабелей на Агрегате Непрерывной Вулканизации',
    ],
    [
        'work' => 'Ведущий инженер - техногог',
        'dateStart' => 'Аперль 2022 -',
        'dateEnd' => 'По текущее время',
        'description' => 'Контроль и поддержание стабильности процесса волочения проволоки',
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <?php echo $work_experience[$i]['dateStart']?>
            <?php echo $work_experience[$i]['dateEnd']?></h6>
            <?php else: ?>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
            <?php echo $work_experience[$i]['dateStart']?>  
            <span class="w3-tag w3-teal w3-round">
            <?php echo $work_experience[$i]['dateEnd']?></span></h6>
            <?php endif; ?>
